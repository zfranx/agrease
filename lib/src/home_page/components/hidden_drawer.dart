...
import 'package:agrease/data/languages.dart';
import 'package:agrease/helper/lang_controller.dart';
import 'package:agrease/services/classify.dart';
import 'package:agrease/services/disease_provider.dart';
import 'package:agrease/services/hive_database.dart';
import 'package:agrease/src/home_page/models/disease_model.dart';
import 'package:agrease/src/suggestions_page/suggestions.dart';
import 'package:agrease/src/widgets/big_text.dart';
import 'package:agrease/src/widgets/small_text.dart';
    ...
    return GestureDetector(
      onTap: () async {
        ...
        if (selectedOption == "English") {
          ...
          updateLocale(Locale("ja", "JP"), context);
          langController.setLanguagecode("ja");
        } else if (selectedOption == "Indonesian") {
          updateLocale(Locale("id", "ID"), context);
          langController.setLanguagecode("id");
        }
      },
      child: Chip(
